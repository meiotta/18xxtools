...
const TILE_PACKS = {
  ...
  // ────────────────────────────────────────────────────────────────────────────
  // WHITE TILES
  // Blank hex backgrounds used for unimproved map hexes (towns, cities, blanks).
  // Toggled OFF by default — include them if the game uses un-placed white tiles
  // in the tile box (rare; most games just use the blank white hex).
  // ────────────────────────────────────────────────────────────────────────────
  'White Tiles': {
    white: {
